...
call claude -p "Read C:\Users\awsom\Documents\Projects\trading-agent\ops\SESSION_PROMPT.md and follow it exactly. Session type: %TYPE%." --max-turns 160 >> ops\logs\sessions.log 2>&1
